...
class StudentsInCourseAdapter(private val studentViewModel: StudentViewModel, private val connections: LiveData<List<StudentCourse>>, private val courseId: Int):ListAdapter<Student, StudentsInCourseAdapter.StudentHolder>(StudentsInCurseDiff) {
    ...
    override fun onBindViewHolder(holder: StudentHolder, position: Int) {
        ...
        if (thisStudentCourse != null){
            ...
            textViewSurname.isVisible = false
            buttonE.isVisible = false
...
object StudentsInCurseDiff : DiffUtil.ItemCallback<Student>() {
